...
- (void)captureOutput:(AVCaptureStillImageOutput *)output
  didFinishProcessingPhotoSampleBuffer:(CMSampleBufferRef)photoSampleBuffer
...
@property(readonly, nonatomic) AVCaptureStillImageOutput *capturePhotoOutput;
...
- (void)setFlash:(BOOL)isEnabled; //for torch
@end
...
- (void)handleMethodCallAsync:(FlutterMethodCall *)call result:(FlutterResult)result {
  if ([@"availableCameras" isEqualToString:call.method]) {
    ...
    /*
      Beacon App Override: 
        - The Camera Plugin previously used AVCaptureDeviceDiscoverySession to fetch
          the device's camera
        - Now, our app is using AVCaptureDeviceDiscoverySession's predecessor 
          AVCaptureDevice.devicesWithMediaType to support iOS Camera 8.0-10.0
    */
